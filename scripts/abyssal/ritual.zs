...
mods.abyssalcraft.InfusionRitual.addRitual("TwilightOrb", 0, -1, 2000, false, <contenttweaker:twilight_orb>, <botania:petalblock:13>, [<minecraft:bone_block>, <primal:sapling>, <abyssalcraft:dltleaves>, <natura:overworld_leaves:3>, <minecraft:bone_block>, <minecraft:double_plant:5>, <abyssalcraft:dltleaves>, <natura:overworld_leaves:3>
], false, ["ench"]); game.setLocalization("ac.ritual.twilightOrbInfusion", "Infusion of the Twilight Orb! Throw this item into a 2x2 water pool surrounded by plants, to make your portal.");

mods.abyssalcraft.InfusionRitual.addRitual("BeneathTeleporter", 0, -1, 1500, false, <beneath:teleporterbeneath>, <progressiontweaks:blank_teleporter>,
